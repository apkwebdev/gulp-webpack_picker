...
const pickerDir = './#picker/';
const projectDir = './#project/';
const destDir = './docs/';
// Note: when changing the name of the destination directory from "docs" to another, in "destDir/.gitignore" also change!
const paths = {
  pages: {
    src: projectDir + 'pages/*/*.pug',
    dest: destDir,
    watch: [pickerDir + '**/*.pug', projectDir + '**/*.pug', '!' + projectDir + 'fonts/', '!' + projectDir + 'images/', '!' + projectDir + 'scripts/'],
    clean: destDir + '**/*.html'
  },
  styles: {
    src: {
      root: projectDir + 'styles/**/*.scss',
      pages: projectDir + 'pages/*/*.scss'
    },
    dest: {
      root: destDir + 'styles/',
      pages: destDir + 'styles/pages/'
    },
    watch: [pickerDir + '**/*.scss', projectDir + '**/*.scss', '!' + projectDir + 'fonts/', '!' + projectDir + 'images/', '!' + projectDir + 'scripts/'],
    clean: destDir + 'styles/'
  },
  scripts: {
    src: projectDir + 'scripts/**/*.js',
    dest: destDir + 'scripts/',
    watch: [pickerDir + '**/*.js', '!' + pickerDir + 'vendor/', projectDir + '**/*.js', '!' + projectDir + 'fonts/', '!' + projectDir + 'images/', '!' + projectDir + 'settings/', '!' + projectDir + 'styles/'],
    clean: destDir + 'scripts/'
  },
  vendor: {
    src: pickerDir + 'vendor/**/*.js',
    dest: destDir + 'scripts/vendor/',
    watch: pickerDir + 'vendor/**/*.js'
  },
  fonts: {
    src: projectDir + 'fonts/**/*.*',
    dest: destDir + 'fonts/',
    watch: projectDir + 'fonts/**/*.*',
    clean: destDir + 'fonts/'
  },
  favicons: {
    src: projectDir + 'images/favicons/*.{jpg,jpeg,png,gif}',
    dest: destDir + 'images/favicons/',
    watch: projectDir + 'images/favicons/*.{jpg,jpeg,png,gif}',
    clean: destDir + 'images/favicons/'
  },
  spritePNG: {
    src: projectDir + 'images/sprites/png/*.png',
    dest: destDir + 'images/sprites/',
    watch: projectDir + 'images/sprites/png/*.png',
    clean: destDir + 'images/sprites/png/',
    mixins: projectDir + 'settings/presets/'
  },
  spriteSVG: {
    src: projectDir + 'images/sprites/svg/*.svg',
    dest: destDir + 'images/sprites/',
    watch: projectDir + 'images/sprites/svg/*.svg',
    clean: destDir + 'images/sprites/svg/'
  },
  webp: {
    src: projectDir + 'images/content/*.{gif,png,jpg,jpeg}',
    dest: destDir + 'images/content/webp/',
    watch: projectDir + 'images/content/*.*',
    clean: destDir + 'images/content/webp/'
  },
  imageMin: {
    src: projectDir + 'images/content/*.{gif,png,jpg,jpeg,svg}',
    dest: destDir + 'images/content/other/',
    watch: projectDir + 'images/content/*.*',
    clean: destDir + 'images/content/other/'
  },
  video: {
    src: projectDir + 'images/video/*.*',
    dest: destDir + 'images/content/video/',
    watch: projectDir + 'images/video/*.*',
